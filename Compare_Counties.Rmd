...
lollipop_chart <- county_pop_1980_2020 %>% 
  ...
  labs(y="", x = "",
       title="Mexican and Population Growth , 2022",
...
collar_mexican_map_2022 <-
  ...
  tm_text("NAME" , size = 1.5, alpha = 1, fontface="bold", fontfamily = "sans", col = "black",  ymod = 1.8) +
...
pop_latino_2000_2020_tb <- pop_latino_2000_2020 %>% 
  select(origin, count_2000, per_2000, count_2010, per_2010, `count_2018-2022`, `per_2018-2022`) %>%
  ...
  kable(booktabs = T,
      ...
      align = c("l","l"  ,rep("c",6)),
      caption = "Hispanic/Latino Population in Cook County and Collar Counties by Origin and Year, Illinois, 1990 to 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "") %>%
  kable_classic(full_width = F,
                font_size = 8,
  ...
  column_spec(1, width = "10em") %>%
  column_spec(2:6, width = "8em") %>%
  add_header_above( c("Origin", "2000" = 2, "2010" = 2, "2018-2022" = 2),
                    # background = "#cbc9e2",
                    bold = T, font_size =8) %>%
  row_spec(0, bold = T,
           # background = "#f2f0f7",
