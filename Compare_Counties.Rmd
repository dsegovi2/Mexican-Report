...
# 
# map_origin_MSA_1980 <- 
#   tm_shape(osm_chicago)+
#   tm_rgb(alpha=.4 , saturation = .6) +
#   tm_shape(MSA_county) +
#   tm_polygons(col = "white",
#              alpha = 0.3)+
# 
#   tm_shape(MSA_dots_1980_origin_50) +
#   tm_dots(col = "Origin",
#           palette = origin_colors_1980,
#           legend.show = FALSE,
#           size = 0.035)+
#   
#   tm_shape(state) +
...
#              lwd = 2,
#              lty= "dashed")+
#    tm_text("NAME" , size = 0.8, alpha = .8, fontface="bold", fontfamily = "sans") +
#   
#   tm_shape(MSA_county) +
#   tm_borders(col = "#343a40",
#              alpha = 0.7,
...
#              lwd = 1) +
#   
#   # tm_text("label" , size = 0.7, alpha = .8, fontface="bold", fontfamily = "sans") +
#   
#   tm_shape(Chicago_shp) +
#   tm_borders(col = "#6c757d",
#              alpha = 0.5,
#              lwd = 2.5) +
#   tm_shape(MSA_Boundary) +
#   tm_borders(col = "#343a40",
#              alpha = 0.7,
#              lwd = 3) +
#   
...
#              # main.title = "Density of Persons of Spanish Origin in Chicago City, 1980",
#              # main.title.size = 1.2,
...
#             legend.position = c(0.03, 0.09),
#             legend.bg.color = "white",
#             legend.bg.alpha = .3) +       # manually position legend) +
#   
#   tm_credits("Spanish/Hispanic Origin or Descent in Chicago Metropolitan\nStatistical Area, 1980",
#              fontface = "bold",
#              position = c("left","top"), size = 1.3) +
#   
...
#                 labels = c("Mexican", "Other Spanish", "Puerto Rican", "Cuban"), 
#                 col = c("#9eb7e5", "#8b5e34", "#ff8500", "#d00000"),
#                 size = 0.5,
#                 title = "1 dot = 50 People") +
#   
#   tm_add_legend("line", 
#                 labels = c("MSA Counties", "Place Borders"), 
#                 col = c("#343a40", "#6c757d"), 
#                 lwd = c(3, 1),
#                 title = "Border Types",
#                 size = 0.7) +
#   
#   
#   # tm_credits("1 dot = 50 People",
#   #            position = c(0.03, 0.18), size = 0.8, fontface = "bold") +
