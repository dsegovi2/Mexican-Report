...
<!--   mutate(label = paste0("Total in Labor Force", ":\n", scales::comma(number))) -->


<!-- unemployment2 <- unemployment1 %>% -->
...
<!--            width=0.7) + -->
<!--   labs(y="", x = "", -->
<!--        title="Employment Status by Race/Ethnicity\nin Chicago, 2018-2022", -->
...
<!--             # hjust = 0.5, -->
<!--             size = 3)+ -->
<!--   geom_text(data =unemployment1 %>%  filter(empl_stat == "Employed") , aes(label = "Total in Labor Force"), -->
<!--             position=position_dodge(width=0.9), hjust = -0.7, vjust = -0.7, -->
<!--             size = 2)+ -->
<!--   geom_text(aes(label = scales::comma(number)), -->
<!--             position=position_dodge(width=0.9), hjust = -0.7, vjust = -0.35, -->
<!--             size = 2) -->
