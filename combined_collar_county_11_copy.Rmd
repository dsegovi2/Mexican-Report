...
# Key Demographic Patterns of Mexican Population in Chicago and Cook County, and the Chicago MSA Over Time
...
mxc_pop_2020_collar_cook_tb <- mxc_pop_2020_collar_cook %>%
  ...
  ## using kable
  kable(booktabs = T,
        col.names = c("Area", "Mexican Population", "Hispanic or Latino Population", "Total Population",
...
#   add_footnote(
#   c(
#     "\\footnotesize{Data Source: IPUMS NHGIS, University of Minnesota, www.nhgis.org (2018-2022 American Community Survey 5-year Estimates). Tabulations by Great Cities Institute.}"
#   ),
#   notation = "none",
#   threeparttable = TRUE,
#   escape = FALSE
...
collar_mexican_map_2022 <-
  ...
  tm_polygons(
    col = "mexican",
    palette = c("#ffedd8", "#f3d5b5", "#e7bc91", "#d4a276", "#bc8a5f"),
  ...
  tm_add_legend("fill",
                ...
                col = c("#ffedd8", "#f3d5b5", "#e7bc91", "#d4a276", "#bc8a5f"),
                alpha = 0.9,
                lwd = .3,
...
county_pop_1990_2020_tb2 <- county_pop_1990_2020 %>%
  ...
  add_header_above( c("Area", "1990" = 2,  "2000" = 2, "2010" = 2, "2018-2022" = 2, "Change from\n1990 to 2018-2022" = 2),
                    # background = "#cbc9e2",
                    bold = T, font_size =8) %>%
  row_spec(0, bold = T, align = "c",
           # background = "#f2f0f7",
...
line_chart <- county_pop_1990_2020 %>%
  ...
  theme_plots +
  labs(y="", x = "",
       title="Figure 1: Mexican Population in Chicago, Cook County, and Collar Counties,\n1990, 2000, 2010 (Decennial Censuses), and 2018-2022 (ACS 5-year Estimates)",
...
Community_areas <-
  ...
  tm_credits("Map 2: Community Areas in Chicago",
             fontface = "bold",
...
comm_mexican_pop_map_2022 <-
  ...
  tm_credits("Map 3: Mexican Population by Community Area in Chicago,\n2018-2022 (ACS 5-year Estimates)",
             fontface = "bold",
             position = c("left","top"), size = 1.25) +
...
comm_mexican_pop_map_2010 <-
  ...
  tm_credits("Map 4: Mexican Population by Community Area in Chicago,\n2010 (Decennial Census)",
             fontface = "bold",
             position = c("left","top"), size = 1.25) +
...
comm_mexican_pop_map_2000 <-
  ...
  tm_credits("Map 5: Mexican Population by Community Area in Chicago,\n2000 (Decennial Census)",
             fontface = "bold",
             position = c("left","top"), size = 1.25) +
...
comm_mexican_prc_map_2022 <-
  ...
  tm_credits("Map 6: Percent Mexican Population by Community Area in Chicago,\n2018-2022 (ACS 5-year Estimates) ",
             fontface = "bold",
             position = c("left","top"), size = 1.25) +
...
comm_mexican_prc_map_2010 <-
  ...
  tm_credits("Map 7: Percent Mexican Population by Community Area in Chicago,\n2010 (Decennial Census) ",
             fontface = "bold",
             position = c("left","top"), size = 1.25) +
...
comm_mexican_prc_map_2000 <-
  ...
  tm_credits("Map 8: Percent Mexican Population by Community Area in Chicago,\n2000 (Decennial Census) ",
             fontface = "bold",
             position = c("left","top"), size = 1.25) +
...
table_1e <- df_final   %>% select(commnty, totl_pp, ttl_hs_, ttl_mxc, prc_mx_ , prc_mxc) %>%
  ...
  kbl(, booktabs = T,
      col.names = c("Total of 10 Community Areas", "Total Population", "Hispanic or Latino Population", "Mexican Population", "% Mexicans of Hispanic or Latino", "% Mexicans of Total Population"),
      align = c("l",rep("r",5)),
 ...
 row_spec(c(10), hline_after = T) %>%
  row_spec(11:13, bold = T,
     ...
     add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS NHGIS, University of Minnesota, www.nhgis.org (2018-2022 American Community \\par\\hspace{-0.5cm} Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_1b.3 <- weighted_age  %>% select(race_ethnicity, weighted_age) %>% 
  ...
  row_spec(0, bold = T,
            ...
            font_size = 8) %>%
add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org \\par\\hspace{-0.5cm} (2018-2022 American Community Survey 5-year Estimates).\\par\\hspace{-0.5cm} Tabulations by Great Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_1b.1 <- df_final %>% 
 ...
 add_header_above(
  ...
  add_footnote(
    c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community Survey 5-year \\par\\hspace{-0.5cm} Estimates). Tabulations by Great Cities Institute.}"),
    notation = "none",
    threeparttable = TRUE,
    escape = FALSE
  )
...
table_1b.2 <-  df_final %>%
  ...
  add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community Survey 5-year Estimates). \\par\\hspace{-0.5cm} Tabulations by Great Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
ggplot(df_long, aes(x = age_group, y = percentage, fill = hispan_breakdown)) +
  geom_bar(stat = "identity", position = "dodge") +
   geom_text(aes(label = sprintf("%.1f%%", percentage)), 
            ...
            size = 2.2, 
            fontface = "bold") +
  labs(title = "Figure 3: Population by Age for Hispanic or Latino Groups\nin Chicago, 2018-2022 (ACS 5-year Estimates)", 
...
table_1d.1 <- income_levels %>% select(race_ethnicity, avg_hhincome, weighted_median_hhincome) %>% 
 ...
 add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-\\par\\hspace{-0.5cm} 2022 American Community Survey 5-year Estimates). Tabulations by Great \\par\\hspace{-0.5cm} Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_1d.2.1 <- income_levels %>% select(race_ethnicity, avg_incwage , weighted_median_incwage) %>% 
  ...
  row_spec(0, bold = T,
   ...
   add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Data covers full-time employees working a minimum of 35 hours per \\par\\hspace{-0.5cm} week for at least 48 weeks each year.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018- \\par\\hspace{-0.5cm}2022 American Community Survey 5-year Estimates). Tabulations by Great \\par\\hspace{-0.5cm} Cities Institute.}" ),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_1d.5 <- poverty_rate_trends_wide  %>% 
 ...
 add_header_above(
  ...
  row_spec(0, 
   ...
   add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2000 Decennial Census, 2018-2012, and 2018-\\par\\hspace{-0.5cm} 2022 American Community Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
df_white_state <- data.frame(
  school_name = "Total CPS White (non-Hispanic or Latino) Students",
...
df_black_state <- data.frame(
  school_name = "Total CPS Black (non-Hispanic or Latino) Students",
...
table_2b <-df_final  %>% select(school_name, percent_ela_proficiency, percent_math_proficiency, percent_science_proficiency) %>% 
  ...
  add_header_above(
    ...
    add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Sample size: 31 Chicago Public Schools Elementary Schools in Gage Park, East Side, West Lawn, and \\par\\hspace{-0.5cm} South Lawndale.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Illinois Report Card (2023). Tabulations by Great Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_2c <-df_final  %>% select(school_name, chronic_absenteeism) %>% 
 ...
 add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Sample size: 31 Chicago Public Schools Elementary Schools in \\par\\hspace{-0.5cm} Gage Park, East Side, West Lawn, and South Lawndale.}",
      "\\footnotesize{\\par\\hspace{-0.5cm} Note: Chronic Absenteeism is defined as students who miss 10 percent or \\par\\hspace{-0.5cm} more of school days per year.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Illinois Report Card (2023). Tabulations by Great Cities \\par\\hspace{-0.5cm} Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_2d <- lep_rate_by_ethnicity %>% select(race_ethnicity, lep_count, lep_percentage) %>% 
  ...
  add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Note: English Proficiency is defined as respondents who does not speak \\par\\hspace{-0.5cm} English or speaks English poorly.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-\\par\\hspace{-0.5cm} 2022 American Community Survey 5-year Estimates). Tabulations by Great \\par\\hspace{-0.5cm} Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
...
table_2g <- df_college %>% pivot_wider(id_cols =  c(race_ethnicity), names_from = "age", values_from = c(college_attendees, percentage_college_students)) %>% select(race_ethnicity,  college_attendees_18_24,  percentage_college_students_18_24,  college_attendees_25_34,  percentage_college_students_25_34) %>%
  ...
  add_header_above( align = c("l", "c", "c"), c("Race/Ethnicity", "Ages 18-24" = 2, "Ages 25-34" = 2),
   ...
   add_footnote(
    c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community \\par\\hspace{-0.5cm} Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
    notation = "none",
    threeparttable = TRUE,
    escape = FALSE
  )
...
table_2h <- education_rates %>% select(race_ethnicity, education_level, weighted_n, educational_rate)  %>% pivot_wider(id_cols =  c(education_level), names_from = "race_ethnicity", values_from = c(weighted_n, educational_rate))   %>% select(
  ...
  add_header_above(
    ...
    add_footnote(
    c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
    notation = "none",
    threeparttable = TRUE,
    escape = FALSE
  )
...
table_a3 <- ownership_join2 %>% 
  ...
  row_spec(0, align = "C") %>%
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2000 Decennial Census, 2008-2012, and 2018-2022 \\par\\hspace{-0.5cm} American Community Survey 5-year Estimates).Tabulations by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
  # 
...
table_3.b1 <- overcrowded %>%
  ...
  row_spec(0, bold = T,
           # background = "#f2f0f7",
           font_size = 8) %>%
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Housing is defined as overcrowded if more than one person in the room.}" ,"\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American \\par\\hspace{-0.5cm} Community Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
table_3.b2_2 <- table_3.b2 %>%
  ...
  add_header_above( align = c("l", rep("c",2)), c("Race/Ethnicity", "More than 30% of\nHousehold Income Spent\non Rental Costs" = 2, "More than 50% of\nHousehold Income Spent\non Rental Costs" = 2),
                    # background = "#cbc9e2",
                    bold = T, font_size =8) %>% 
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Rent cost burdened households defined as households paying 30 percent or more of household \\par\\hspace{-0.5cm} income on rental housing costs.}" ,"\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community \\par\\hspace{-0.5cm} Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
table_3.b3_2 <- table_3.b3 %>%
 ...
 kable_classic(full_width = F,
  ...
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Owner cost burdened households defined as households paying 30 percent or more of household \\par\\hspace{-0.5cm} income on owner housing costs.}" ,"\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community \\par\\hspace{-0.5cm} Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
# write_sf(census_community_2022, "C:/Users/dsegovi2/Box/Great Cities Institute/Research/Mexican Report/shp files/census_community_2022.shp")
...
value_map_2020 <-
  ...
  tm_credits("Map 9: Median House Value by Community Area in Chicago,\n2018-2022 (ACS 5-year Estimates)",
             fontface = "bold",
             position = c("left","top"), size = 1.25)+
...
Mhouse_value_plot <- comunity_house_value_shp %>% 
  ...
  geom_bar( stat = "identity", 
           ...
           linewidth = 0.5) +
  labs(y="", x = "",
       title="Figure 5: Median House Value for Chicago Community Areas with\nMore Than 50% Share of Mexican Population,\n2018-2022 (ACS 5-year Estimates) ",
...
table_4c <- df_rates  %>% select(mex_foreign_born, weighted_n_without_insurance, no_insurance_rate)   %>% 
  ...
  row_spec(0, bold = T, align = "c",
            ...
            font_size = 8) %>%
  add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS NHGIS, University of Minnesota, www.nhgis.org \\par\\hspace{-0.5cm} (2018-2022 American Community Survey 5-year Estimates). Tabulations \\par\\hspace{-0.5cm} by Great Cities Institute. }"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
df_white_city <- data.frame(
  commnty = "White (non-Hispanic or Latino) Chicago Mean",
 obesity_rate = 24.5,
  diabetes_rate = 6.9, 
  asthma_rate = 9.1,
  lbw_rate = 6.2
...
df_black_city <- data.frame(
  commnty = "Black (non-Hispanic or Latino) Chicago Mean",
  obesity_rate = 47.6,
  diabetes_rate = 19.6,
  asthma_rate = 14.9, 
  lbw_rate  =14.6
...
table_4a <- df_final %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("r",4)),
      caption = "Health Outcomes for Four Communities with the Largest Share of Mexican Population and by Race/Ethnicity in Chicago, 2017-2021, and 2022-2023",
      format.args = list(big.mark = "%"),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
row_spec(0, bold = TRUE, font_size = 8, align = "c") %>%
  ...
  row_spec(c(4), hline_after = T) %>%  
   ...
   add_footnote(
  c(
      "\\footnotesize{\\par\\hspace{-0.5cm} Note: Obesity is defined as percent of adults who reported a height and weight that yield a body mass \\par\\hspace{-0.5cm} index of 30 or greater.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Diabetes is defined as percent of adults who reported that a doctor, nurse or other health professional has \\par\\hspace{-0.5cm} diagnosed them with diabetes.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Asthma is defined as percent of adults who reported that a doctor, nurse or other health professional has \\par\\hspace{-0.5cm} diagnosed them with asthma.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Low birthweight is defined as percent of births with a birthweight less than 2500 grams (5.5 pounds).}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Data Source:Chicago Health Atlas, Chicago Department of Public Health (2022–2023) and Illinois \\par\\hspace{-0.5cm} Department of Public Health (2017-2021). Tabulations by Great Cities Institute}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
row_spec(0, bold = TRUE, font_size = 8, align = "c") %>%
  ...
  add_footnote(
  c( 
      "\\footnotesize{\\par\\hspace{-0.5cm} Note: Serious Psychological Distress is the percent of adults who experienced feelings of nervousness, \\par\\hspace{-0.5cm} hopelessness, and depression, in the past 30 days.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Unmet mental health need is the percent of adults with psychological distress who are not receiving \\par\\hspace{-0.5cm} treatment or medication.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Loneliness rate is defined as the percent of adults who reported feeling left out or felt alone.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Chicago Health Atlas, Chicago Department of Public Health (2022–2023) and Illinois \\par\\hspace{-0.5cm} Department of Public Health (2017-2021).Tabulations by Great Cities Institute.}"
...
table_4f <- df_final %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("r",3)),
      caption = "Chronic Health Indicators for Four Communities with the Largest Share of Mexican Population and by Race/Ethnicity in Chicago, (2017-2021, and 2022-2023)",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
row_spec(0, bold = TRUE, font_size = 8, align = "c") %>%
  ...
  row_spec(5:7, bold = TRUE
    ...
    add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Cancer diagnosis is defined as the annual diagnosis rate for all invasive cancers, excluding \\par\\hspace{-0.5cm} pre-cancerous conditions.  All ages, risk-adjusted.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Hypertension is the percentage of adults diagnosed with high blood pressure, excluding borderline or \\par\\hspace{-0.5cm} pregnancy-related cases.}",
    "\\footnotesize{\\par\\hspace{-0.5cm} Lung cancer is defined as lung and bronchus cancer for ages 15 and over, risk-adjusted.}", "\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Chicago Health Atlas, Chicago Department of Public Health (2022–2023) and Illinois \\par\\hspace{-0.5cm} Department of Public Health (2017-2021).Tabulations by Great Cities Institute.}"
...
table_5.a1 <- unemployment %>%
 ...
 kable_classic(full_width = F,
  ...
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2018-2022 American Community \\par\\hspace{-0.5cm} Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
LFP_rate %>%
  ...
  geom_bar(position=position_dodge(width=0.7), stat = "identity",
           ...
           width=0.7) +
  labs(y="", x = "",
       title="Figure 6: Labor Force Participation Rate for Mexicans and Other\nRacial/Ethnic Groups in Chicago, 2000 (Decennial Census),\n2008-2012, and 2018-2022 (ACS 5-year Estimates)",
...
occupation %>%
  ...
  geom_bar(position = "stack", stat = "identity",
           ...
           width=2/3) +
  labs(y="", x = "",
       title="Figure 7 : Percent Share of Occupation Employment for\nMexicans and Other Racial/Ethnic Groups in Chicago,\n2018-2022 (ACS 5-year Estimates)",
...
```{r}
# new table goes here for top 10 sub industry employment by sex
occupation4 <- usa_data %>%
  filter( city == 1190, year == 2022) %>%  #### dont forget to filter PUMA   ## Should I filter pernum or not?

  as_survey_design(weights = perwt) %>%
  survey_count(race_ethnicity, sex_f, occ, employment=empstat_f, name="count") %>%
  filter(employment == "Employed") %>%
  group_by(occ) %>%
  mutate(total_employed = sum(count, na.rm = T)) %>% 
mutate(sex_f = factor(sex_f, levels = c("Male", "Female")))
  # mutate(prc = 100* round(count/total_employed, 4),
  #        prc2 = paste0(format(round(prc, 1), nsmall = 1), "%")) %>%
  # filter(!is.na(occ)) %>%
  # ungroup()
...
top_occ_male_mxc <- occupation4 %>%
  filter(race_ethnicity == "Mexican" & sex_f == "Male") %>%
  group_by(occ) %>%
  mutate(prc = 100* round(count/total_employed, 4),
         prc2 = paste0(format(round(prc, 1), nsmall = 1), "%")) %>%
  filter(!is.na(occ)) %>%
...
top_occ_female_mxc <- occupation4 %>%
  filter(race_ethnicity == "Mexican" & sex_f == "Female") %>%
  group_by(occ) %>%
  mutate(prc = 100* round(count/total_employed, 4),
         prc2 = paste0(format(round(prc, 1), nsmall = 1), "%")) %>%
  filter(!is.na(occ)) %>%
...
occupation5 <-  occupation4 %>%
  filter(occ %in% top_occ_male_mxc & race_ethnicity == "Mexican" & sex_f == "Male"|
         occ %in% top_occ_female_mxc & race_ethnicity == "Mexican" & sex_f == "Female") %>% 
  group_by(sex_f, occ) %>% 
  mutate(prc = 100* round(count/total_employed, 4),
         prc2 = paste0(format(round(prc, 1), nsmall = 1), "%")) %>% 
  
  mutate(sub_Occupation = case_when(occ == 2310 ~ "Elementary and middle school teachers",
                                    occ == 4020 ~ "Cooks",
                                    occ == 4110 ~ "Waiters and waitresses",
         ...
         Occupation_group = case_when(occ == 2310 ~ "Education, Legal, Community Service, Arts, and Media Occupations",
                                      occ == 4020 ~ "Service Occupations",
                                      occ == 4110 ~ "Service Occupations",
                                      occ == 4220 ~ "Service Occupations",
                                      occ == 4230 ~ "Service Occupations",
                                      occ == 4600 ~ "Service Occupations",
                                      occ == 4720 ~ "Sales and Related Occupations",
                                      occ == 4760 ~ "Sales and Related Occupations",
                                      occ == 5240 ~ "Office and Administrative Support Occupations",
                                      occ == 5740 ~ "Office and Administrative Support Occupations",
                                      occ == 4251 ~ "Service Occupations",
                                      occ == 6230 ~ "Construction and Extraction Occupations",
                                      occ == 6260 ~ "Construction and Extraction Occupations",
                                      occ == 6410 ~ "Construction and Extraction Occupations",
                                      occ == 7200 ~ "Installation, Maintenance, and Repair Occupations",
                                      occ == 8990 ~ "Production Occupations",
                                      occ == 9130 ~ "Transportation and Material Moving Occupations",
                                      occ == 9620 ~ "Transportation and Material Moving Occupations")) %>% 
  
  arrange(factor(sex_f, levels = levels(occupation4$sex_f)), desc(count)) %>%
  ungroup()
...
table_5a.3_3 <-  occupation5 %>%
  ...
  kable(booktabs = T,
        col.names = c("Occupation Group","Sub-occupation ", "Number", "% Share of Occupation Employment"   ),
      align = c("l","l" ,rep("r",2)),
      caption = "Employment by Industry and Percent Share of Occupation Employment for 10 Sub-occupations Where Mexican Males and Females Have the Highest Number of Employees in Chicago, 2018-2022 (ACS 5-year Estimates)",
      format.args = list(big.mark = ","),
      linesep = "") %>%
  kable_classic(full_width = F,
                font_size = 8,
  ...
  row_spec(0, bold = T, align = "c",
           # background = "#f2f0f7",
           font_size = 7.5) %>%
  pack_rows("Mexican Males", 1,10, hline_after = T  , indent=FALSE) %>%
  pack_rows("Mexican Females", 11, 20, hline_before = T , hline_after = T, indent=FALSE) %>% 
...
cps_ddi <- read_ipums_micro(read_ipums_ddi("C:/Users/dsegovi2/Box/Great Cities Institute/Research/Mexican Report/cps_00172.xml")) %>%
  clean_names()
...
table5b <- Union %>%
 ...
 kable_classic(full_width = F,
  ...
  row_spec(0, bold = T, align = "c",
           # background = "#f2f0f7",
           font_size = 8) %>%
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS CPS, University of Minnesota, www.ipums.org. (2022 Current Population Survey). \\par\\hspace{-0.5cm} Tabulations by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
latino_gdp_tb <-  latino_gdp %>%
 ...
 kable_classic(full_width = F,
  ...
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: 2023 U.S. Latino GDP Report, www.LatinoGDP.us \\par\\hspace{-0.5cm} (CLU-CERF, Bank of America State and Metro Latino GDP Reports).}"),
          notation = "none",
           threeparttable = T,
           escape = FALSE)
...
country_gdp_tb <- country_gdp %>% 
 ...
 kable_classic(full_width = F,
  ...
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: 2023 U.S. Latino GDP Report, www.LatinoGDP.us \\par\\hspace{-0.5cm} (International Monetary Fund and Organization for Economic Cooperation \\par\\hspace{-0.5cm} and Development).}"),
          notation = "none",
           threeparttable = T,
           escape = FALSE)
...
median_net_worth <- data.frame(
  Hispanic_origin_group = c("Mexican", "Native-born Mexican", "Foreign-born Mexican", "Puerto Rican", 
                            "Cuban", "Salvadoran", "Dominican", "Colombian", "Other Hispanic", 
                            "Not Hispanic", "Hispanic"),
  Median_household_net_worth = c(52440, 52650, 47530, 35770, 92700, 30600, 9430, 141200, 58490, 195600, 52190),
  Standard_error = c(3640, 3088, 5403, 20280, 31780, 7468, 7428, 72690, 14130, 5202, 3260)
) %>% 
  mutate(Median_household_net_worth = paste0("\\$", scales::comma(Median_household_net_worth)),
         Standard_error = paste0("\\$", scales::comma(Standard_error))) %>% 
  mutate(Hispanic_origin_group = cell_spec(Hispanic_origin_group, italic = ifelse(row_number() %in% c(2,3), T, F))) %>% 
  mutate(Hispanic_origin_group = ifelse(row_number() %in% c(2,3), paste0("\\hspace{.7em}", Hispanic_origin_group), Hispanic_origin_group))



median_net_worth_tb <- median_net_worth %>% 
  kbl(booktabs = T, escape = F,
      col.names = c("Hispanic Origin Group",  "Median Household Net Worth", "Standard Error"),
      align = c("l",rep("r",2)),
      caption = "Median Household Net Worth by Detailed Hispanic Origin, 2020",
      format.args = list(big.mark = ","),
      linesep = "") %>%
 kable_classic(full_width = F,
                font_size = 8,
  ...
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Use caution with estimates having coefficients of variation (defined as the \\par\\hspace{-0.5cm} standard error divided by the estimate) larger than 0.3 as they may suffer from \\par\\hspace{-0.5cm} data quality issues.}", "\\footnotesize{\\par\\hspace{-0.5cm} Source: U.S. Census Bureau, 2021 Survey of Income and Program Participation, \\par\\hspace{-0.5cm} public-use data.}", "\\footnotesize{\\par\\hspace{-0.5cm} Reproduced from a table by: Zachary Scherer and Yerís H. Mayol-García, \\par\\hspace{-0.5cm} statisticians in the Census Bureau’s Social, Economic, and Housing Statistics Division.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
business_ownership_tb <- business_ownership %>% 
 ...
 kable_classic(full_width = F,
  ...
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Note: Counts include only businesses classifiable by owner demographic group}", "\\footnotesize{\\par\\hspace{-0.5cm} Data Sources: Annual Business Survey, 2021 \\par\\hspace{-0.5cm} (Census); Nonemployer Statistics by Demographics, 2021 (Census)
}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
business_ownership %>%
  ...
  geom_bar(position=position_dodge(width=0.7), stat = "identity",
           ...
           width=0.7) +
  labs(y="", x = "",
       title="Figure 8: Share of Business Ownership (2021) and Population\nby Race/Ethnicity (2018-2022 ACS 5-year Estimates) in\nChicago−Naperville−Elgin, IL−IN−WI Metro Area",
...
ethnicity_data <- data.frame(
  Ethnicity = c("Caucasian", "African-American", "Hispanic", "Asian", "Unable to Verify Ethnicity", "Total"),
  n_2012 = c(166, 4, 2, 8, 27, 207),
  pct_2012 = c("80.2%", "1.9%", "1.0%", "3.9%", "13.0%", "100.0%"),
  n_2014 = c(163, 8, 3, 6, 20, 200),
  pct_2014 = c("81.5%", "4.0%", "1.5%", "3.0%", "10.0%", "100.0%"),
  n_2016 = c(174, 7, 4, 6, 13, 204),
  pct_2016 = c("85.3%", "3.4%", "2.0%", "2.9%", "6.4%", "100.0%"),
  n_2018 = c(184, 11, 6, 5, 10, 216),
  pct_2018 = c("85.2%", "5.1%", "2.8%", "2.3%", "4.6%", "100.0%"),
  n_2020 = c(210, 16, 12, 15, 1, 254),
  pct_2020 = c("82.7%", "6.3%", "4.7%", "5.9%", "0.4%", "100.0%"),
  n_2022 = c(221, 23, 7, 27, 0, 278),
  pct_2022 = c("79.5%", "8.3%", "2.5%", "9.7%", "0.0%", "100.0%"),
  Percentage_Point_Difference = c("-0.7%", "6.3%", "1.6%", "5.8%", "-13.0%", "0.0%")
) 



ethnicity_data_tb <- ethnicity_data %>% 
  kbl(booktabs = T, 
      col.names = c("","Number",  "Percent", 
                    "Number",  "Percent",
                    "Number",  "Percent",
      ...
      align = c("l",rep("r",13)),
      caption = "Race/Ethnicity Status of C-Suite Executives for Top 50 Companies in Chicago, 2012-2022",
      format.args = list(big.mark = ","),
      linesep = "") %>%
 kable_classic(full_width = F,
                font_size = 8,
                ...
                latex_options = "HOLD_position") %>%
  column_spec(1, width = "7em") %>%
  column_spec(2:13, width = "2.3em") %>%
  column_spec(14, width = "3.5em") %>%
  add_header_above(align = c("l", rep("c",7)), c("Race/Ethnicity",  "2012" = 2,"2014" =2 ,"2016" = 2,
                                                 "2018" = 2, "2020" =2 ,"2022" = 2,
                                                 "2012-2022"),
                    # background = "#cbc9e2",
                    bold = T, font_size =8) %>%
  row_spec(0, 
           ...
           font_size = 8) %>% 
  column_spec(1, width = "10em") %>%
  column_spec(2:14, width_min = "2.5em") %>%
  # row_spec(3, hline_after = T, extra_latex_after = "%") %>% 
  add_footnote(c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Chicago United Inside Inclusion. Data compiled by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
# Create the data frame without year-specific columns
df_boards <- data.frame(
  Race_Ethnicity = c("Caucasian", "African-American", "Hispanic", "Asian", "Unable to Verify Ethnicity", "Total"),
  n_2012 = c(540, 41, 19, 15, 26, 641),
  pct_2012 = c("84.2%", "6.4%", "3.0%", "2.3%", "4.1%", "100.0%"),
  n_2014 = c(466, 34, 19, 16, 16, 551),
  pct_2014 = c("84.6%", "6.2%", "3.4%", "2.9%", "2.9%", "100.0%"),
  n_2016 = c(463, 44, 19, 14, 17, 557),
  pct_2016 = c("83.1%", "7.9%", "3.4%", "2.5%", "3.1%", "100.0%"),
  n_2018 = c(461, 42, 22, 14, 16, 555),
  pct_2018 = c("83.1%", "7.6%", "4.0%", "2.5%", "2.9%", "100.0%"),
  n_2020 = c(461, 50, 23, 16, 3, 553),
  pct_2020 = c("83.4%", "9.0%", "4.2%", "2.9%", "0.5%", "100.0%"),
  n_2022 = c(375, 67, 20, 23, 4, 489),
  pct_2022 = c("76.7%", "13.7%", "4.1%", "4.7%", "0.8%", "100.0%"),
  Percentage_Point_Difference = c("-7.6%", "7.3%", "1.1%", "2.4%", "-3.2%", "0.0%")
)
...
# kable
  ...
  # using kable
table_boards <- df_boards %>%  kbl(, booktabs = T,
      col.names = c("","Number",  "Percent", 
                    "Number",  "Percent",
                    "Number",  "Percent",
                    "Number",  "Percent",
                    ...
                    "Percentage Point Difference"),
      align = c("l", rep("r", 13)),
      caption = "Race/Ethnicity of Boards of Directors for Top 50 Companies in Chicago, 2012-2022",
     format.args = list(big.mark = ","),
      linesep = "") %>%
  kable_classic(full_width = F,
                font_size = 8,
  ...
  row_spec(0, align = "c",
           ...
           font_size = 8) %>% 
  column_spec(1, width = "10em") %>%
  column_spec(2:13, width_min = "2.5em") %>%
  column_spec(14, width = "3.5em") %>%
  add_header_above(align = c("l", rep("c",7)), c("Race/Ethnicity" , "2012" = 2, 
                                                 "2014" = 2, 
                                                 "2016" = 2, 
                                                 "2018" = 2, 
                                                 "2020" = 2, 
...
add_footnote(c("\\footnotesize{
\\par\\hspace{-0.5cm} Data Source: Chicago United Inside Inclusion. Data compiled by Great Cities Institute.}"),
notation = "none",
threeparttable = T,
escape = FALSE)
...
```{r}
 ...
 kable_classic(full_width = F,
  ...
  row_spec(0, align = "c",
   ...
   add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2000 Decennial Census, 2008-2012,\\par\\hspace{-0.5cm}  and 2018-2022 American Community Survey 5-year Estimates). Tabulations by Great Cities Institute.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_6D <- illinois_legislature %>%  
  ...
  add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Illinois Legislative Latino Caucus Foundation. Tabulation by Great Cities Institute}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_6b <- election_df %>%  kbl(, booktabs = T,
  ...
  add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data source: U.S. Census Bureau, 'Voting and Registration in Election of November 2020,' Table 4a 'Voting and \\par\\hspace{-0.5cm} Registration By States,' GCI tabulation of states with more than 300,000 Latino citizens over age 18.}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
table_6c <- voting_df %>%  
  ...
  add_footnote(
  c("\\footnotesize{\\par\\hspace{-0.5cm} Data Source: Chicago's 2023 Mayoral Race: A Progressive Victory Amidst Shocking Low Turnout by Black and Latino Voters \\par\\hspace{-0.5cm} (Calculations from Chicago Board of Election Commissioners 2023 Municipal Runoff Election Results and 2020 U.S. Census.)}"),
  notation = "none",
  threeparttable = TRUE,
  escape = FALSE
)
...
# Mexicans in Cook County and Collar Counties
...
pop_latino_2000_2020_tb <- pop_latino_2000_2020 %>%
  ...
  row_spec(c(7,8, 15,16, 23, 24, 31, 32, 39, 40, 47, 48) 
           # background = "#e6e0f1"
           ) %>%
