...
table_2i <-df_final  %>% select(school_name, percent_ela_proficiency, percent_math_proficiency, percent_science_proficiency) %>% 
  ...
  footnote(
    ...
    Sample size: 31 CPS Elementary Schools in 4 Community Areas (Gage Park, East Side, West Lawn, South Lawndale)",
    general_title = ""
  ) 
table_2i
...
table_2j <-df_final  %>% select(school_name, chronic_absenteeism) %>% 
  ...
  footnote(
    general = "Source: Illinois Report Card (2023). Tabulations by Great Cities Institute
    Sample size: 31 CPS Elementary Schools in 4 Community Areas (Gage Park, East Side, West Lawn, South Lawndale)
    Chronic Absenteeism defined as students who miss 10% or more of school days per year with or without a valid excuse.",
    general_title = ""
  ) 
table_2j
