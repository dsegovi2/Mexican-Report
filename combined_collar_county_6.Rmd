...
## Health Outcomes for Four Communities with the Largest Share of Mexican Population and by Race/Ethnicity in Chicago, (2017-2021, aand 2022-2023):
...
table_4a <- df_final %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("r",4)),
      caption = "Health Outcomes for Four Communities with the Largest Share of Mexican Population and by Race/Ethnicity in Chicago, 2017-2021, aand 2022-2023",
      format.args = list(big.mark = "%"),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
