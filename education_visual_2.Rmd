...
# Plot
ggplot(df_bachelors, aes(x = hispan_breakdown, y = educational_rate, fill = hispan_breakdown)) +
  geom_bar(stat = "identity", position = position_dodge(width = 0.8)) +
  scale_fill_manual(values = color_hispan_breakdown) +
  labs(x = "Race/Ethnicity", y = "Educational Rate (%)", fill = "Ethnicity") +
...
fontface = "bold") + 
  labs(title = "Share of U.S. Population Ages 25-34 with a Bachelor's Degree\n or Higher by Detailed Hispanic Origin in Chicago, 2008-2012 and 2018-2022\n(ACS 5-year Estimates)", 
       caption = "Data Source: IPUMS USA, University of Minnesota, www.ipums.org (2008-2012, 2018-2022 American Community Survey \n  5-year Estimates). Tabulations by Great Cities Institute.", fill = ''
)  +
