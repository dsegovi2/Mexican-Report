...
table_1d.3 <- poverty_rate  %>% select(race_ethnicity, total_weighted_poverty_count, poverty_rate) %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("c",2)),
      caption = "Mexican Population at or Below 100% Poverty Threshold, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
