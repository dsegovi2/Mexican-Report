...
color_race_ethnicity <- c("Mexican" = "#CE1126", 
                          "Other Latinos" = "#F9AA51",
                          "White (non-Hispanic or Latino)" = "#4D2B18",
                          "Black (non-Hispanic or Latino)" = "#9CA168",
...
color_hispan_breakdown <- c(
  "Mexican" = "#CE1126",       # Red
  "Puerto Rican" = "#4C9F38",  # Green
  "Ecuadorian" = "#F7E300",    # Yellow
  "Cuban" = "#0033A0",         # Blue
  "Guatemalan" = "#8C6D40",    # Brown
  "Colombian" = "#9B59B6"      # Purple
)
...
table_1d.2.1 <- income_levels %>% select(race_ethnicity, avg_incwage , weighted_median_incwage) %>% 
  ...
  footnote(general = "Source: IPUMS-USA database (2018-2022). Tabulations by Great Cities Institute
           Note: Data pertains to full-time workers who work a minimum of 35 hours per week for at least 48 weeks in a year.",
           general_title = "")   
...
table_1d.2.2 <- income_levels %>% select(race_ethnicity, avg_incwage , weighted_median_incwage) %>% 
  ...
  footnote(general = "Source: IPUMS-USA database (2018-2022). Tabulations by Great Cities Institute
           Note: Data pertains to all employed regardless of full-time or part-time work",
           general_title = "")   
...
table_1d.5 <- poverty_rate_trends_wide  %>% 
 ...
 add_header_above(
    ...
    c(
      ...
      "Poverty in 2012 " = 2, 
      "Poverty in 2022 " = 2, 
      "Differences in Poverty From 2012 through 2022" = 1,
     "Differences in Poverty From 2000 through 2022" = 1),
    bold = TRUE, 
    font_size = 8) %>%
  row_spec(0, bold = T,
             #background = "#f2f0f7",
