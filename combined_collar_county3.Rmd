...
## 1B(1): Population Pyramid and Percentage by race/ethnicity, 2018-2022:
...
select(age_group, 
                                                                                                                                                total_weighted_count_Mexican, total_weighted_percentage_Mexican,
                                                                                                                                                 'total_weighted_count_Other Latinos', 'total_weighted_percentage_Other Latinos',
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("c",10)),
      caption = "Population Pyramid by Race/Ethnicity, 2018-2022",
 ...
 add_header_above( align = c("l", rep("c",2)), c("Age Group", "Mexican" = 2, "Other Latinos" = 2, "White (non-Hispanic or Latino)" = 2, "Black (non-Hispanic or Latino)" = 2, "Other (non-Hispanic or Latino)" = 2),
                    # background = "#cbc9e2", 
                    bold = T, font_size =8) %>% 
...
ggplot(df_long, aes(x = age_group, y = percentage, fill = race_ethnicity)) +
  ...
  labs(title = "Age Group Distribution by Race/Ethnicity", 
       caption = "Source: IPUMS-USA database (2018-2022 American Community Survey 5-Year Estimates). Tabulations by \nGreat Cities Institute") +
...
## 1B(2) Population Pyramid and Percentage of Hispanic or Latino, 2018-2022:
...
table_1b.2 <-  df_final %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l", rep("c", 12)),
      caption = "Population Pyramid by Hispanic or Latino, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "") %>% 
  kable_classic(full_width = F,  
                font_size = 8,
                ...
                latex_options = "HOLD_position") %>% 
  column_spec(1, width = "14.2em") %>%
  column_spec(2:13, width = "2.58em") %>%  
  add_header_above(align = c("l", rep("c", 2)), 
                   c("Age Group", "Mexican" = 2, "Puerto Rican" = 2, "Ecuadorian" = 2, "Cuban" = 2, "Guatemalan" = 2, "Colombian" = 2),
                   bold = T, font_size = 8) %>% 
  footnote(general = "Source: IPUMS-USA database (2018-2022 American Community Survey 5-Year Estimates). Tabulations by \n Great Cities Institute",
           general_title = "")
...
ggplot(df_long, aes(x = age_group, y = percentage, fill = hispan_breakdown)) +
  ...
  geom_text(aes(label = paste0(percentage, "%")), 
            ...
            size = 2, 
            fontface = "bold") +
  labs(title = "Age Group Distribution by Hispanic or Latino", 
     caption = "Source: IPUMS-USA database (2018-2022 American Community Survey 5-Year Estimates). Tabulations by \n Great Cities Institute") +
scale_y_continuous(breaks = seq(0, 40, by = 5)) +
  theme_minimal() +
  scale_fill_manual(values = color_hispan_breakdown, name = "Hispanic or Latino") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + theme_plots +   theme(axis.text.x = element_text(size = 8),
        panel.background = element_blank(),
        axis.ticks.y = element_blank(),
        axis.title.y = element_blank(),
...
## 1B(3): Median Age by Race/Ethnicity, 2018-2022:
...
table_1b.3 <- weighted_age  %>% select(race_ethnicity, weighted_age) %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("c",1)),
      caption = "Median Age by Race/Ethnicity, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
## 1B(4): Median Age of Hispanic or Latino breakdown, 2018-2022:
...
table_1b.4 <- weighted_age  %>% select(hispan_breakdown, weighted_age) %>% 
  ...
  kbl(, booktabs = T,
       col.names = c("Race/Ethnicity", "Number"),
      align = c("l",rep("c",1)),
      caption = "Median Age of Hispanic or Latino breakdown, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
## 1C: Mean Household Size by race/ethnicity, 2018-2022:
...
table_1c <- mean_household_size %>% select(race_ethnicity, mean_household_size) %>% 
  ...
  kbl(, booktabs = T,
       col.names = c("Race/Ethnicity", "Number"),
      align = c("l",rep("c",1)),
      caption = "Mean Household Size by race/ethnicity, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
table_1d.1 <- income_levels %>% select(race_ethnicity, avg_hhincome, weighted_median_hhincome) %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("c",2)),
      caption = "Mean and Median Household Income by Race/Ethnicity, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
table_1d.2.1 <- income_levels %>% select(race_ethnicity, avg_incwage , weighted_median_incwage) %>% 
  ...
  kbl(, booktabs = T,
      ...
      align = c("l",rep("c",2)),
      caption = "Mean and Median Income by Race/Ethnicity, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
add_footnote(c("Note:Data pertains to full-time workers who work a minimum of 35 hours per week for at least 48 weeks in a year.", "Source: IPUMS-USA database (2018-2022 American Community Survey 5-Year Estimates).Tabulations by Great Cities Institute "))
...
add_footnote(c("The data includes all employed individuals, regardless of whether they work full-time or part-time.", "Source: IPUMS-USA database (2018-2022 American Community Survey 5-Year Estimates).Tabulations by Great Cities Institute "))
...
## 1D(3.1): Individual Income Levels for Full-time workers by Hispanic or Latino breakdown, 2018-2022:
...
table_1d.3.1 <- income_levels %>% select(hispan_breakdown, avg_incwage , weighted_median_incwage ) %>% 
  ...
  kbl(, booktabs = T,
      col.names = c("Race/Ethnicity", "Mean Income", "Median Income"),
      align = c("l",rep("c",2)),
      caption = "Mean and Median Income by Hispanic or Latino, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
## 1D(3.2): Individual Income Levels for all workers by Hispanic or Latino, 2018-2022:
...
table_1d.3.2 <- income_levels %>% select(hispan_breakdown, avg_incwage , weighted_median_incwage) %>% 
  ...
  kbl(, booktabs = T,
      col.names = c("Race/Ethnicity", "Mean Income", "Median Income"),
      align = c("l",rep("c",2)),
      caption = "Mean and Median Income by Hispanic by Latino, 2018-2022",
      format.args = list(big.mark = ","),
      linesep = "")  %>% 
  kable_classic(full_width = F,  
                font_size = 8,
...
table_1d.4.2 <- income_levels %>% select(mex_foreign_born, avg_incwage , weighted_median_incwage ) %>% 
 ...
 add_footnote(c("Note:  Data pertains to all employed regardless of full-time or part-time work.", "Source: IPUMS-USA database (2018-2022 American Community Survey 5-Year Estimates).Tabulations by Great Cities Institute "))
...
table_1d.5 <- poverty_rate_trends_wide  %>% 
 ...
 add_header_above(
  ...
  add_footnote(c("Source: IPUMS-USA database (2000 Decennial Census, 2008-2012 and 2018-2022 American Community Survey 5-Year Estimates)", " Tabulations by Great Cities Institute."))
...
table_1e <- df_final   %>% select(commnty, totl_pp, ttl_hs_, ttl_mxc, prc_mx_ , prc_mxc) %>% 
  ...
  add_header_above(
    align = c("l", rep("c", 2)),
    c(
      "Top 10 Community Areas\n with the Largest Mexican Population Share", 
      "Total\n Population" = 1, 
      "Hispanic or\n Latino Population " = 1, 
      "Mexican\n Population" = 1,
 ...
 # Adding line after row 11
  row_spec(11, extra_css = "border-bottom: 1px solid;") %>%  
  row_spec(12:13, bold = T,
             background = "#f2f0f7",
            font_size = 8) %>%

    add_footnote(c("Source: IPUMS-NHGIS database (2018-2022 American Community Survey 5-Year Estimates)", " Tabulations by Great Cities Institute."))
