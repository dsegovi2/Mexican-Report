...
df_boards <- data.frame(
  Race_Ethnicity = c("Caucasian", "African-American", "Hispanic", "Asian", "Unable to Verify Ethnicity"),
  n_2012 = c(540, 41, 19, 15, 26),
  pct_2012 = c("84.2%", "6.4%", "3.0%", "2.3%", "4.1%"),
  n_2014 = c(466, 34, 19, 16, 16),
  pct_2014 = c("84.6%", "6.2%", "3.4%", "2.9%", "2.9%"),
  n_2016 = c(463, 44, 19, 14, 17),
  pct_2016 = c("83.1%", "7.9%", "3.4%", "2.5%", "3.1%"),
  n_2018 = c(461, 42, 22, 14, 16),
  pct_2018 = c("83.1%", "7.6%", "4.0%", "2.5%", "2.9%"),
  n_2020 = c(461, 50, 23, 16, 3),
  pct_2020 = c("83.4%", "9.0%", "4.2%", "2.9%", "0.5%"),
  n_2022 = c(375, 67, 20, 23, 4),
  pct_2022 = c("76.7%", "13.7%", "4.1%", "4.7%", "0.8%"),
  Percentage_Point_Difference = c("-7.6%", "7.3%", "1.1%", "2.4%", "-3.2%")
)
