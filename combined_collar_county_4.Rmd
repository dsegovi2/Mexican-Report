...
comm_mexican_pop_map_2000_2022 <-
  ...
  tm_borders(col = "#343a40",
   ...
   tm_layout( frame = TRUE,
            ...
            main.title = "Mexican Population by Community Area in Chicago, 2000 (Decennial Census), 2010  (Decennial Census), and 2018-2022 (ACS 5-year Estimates)"
...
map_2000_2022 <-
  ...
  tm_borders(col = "#343a40",
   ...
   tm_layout( frame = TRUE,
            ...
            main.title = "Percent Mexican Population by Community Area in Chicago, 2000 (Decennial Census), 2010  (Decennial Census), and 2018-2022 (ACS 5-year Estimates)"
...
country_gdp <- data.frame(
  Country = c("United States", "China", "Japan", "Germany", "US Latinos",
...
business_ownership_tb <- business_ownership %>% 
  kbl(booktabs = T,
      ...
      align = c("l",rep("r",3)),
      caption = "Business count by owner demographic group in Chicago-Naperville-Elgin, IL-IN-WI Metro Area",
      format.args = list(big.mark = ","),
      linesep = "") %>%
 kable_classic(full_width = F,
                font_size = 8,
